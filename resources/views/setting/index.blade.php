                ...
                <div class="card-body">
                    ...
                    <form class="row g-3" method="POST" action="{{ route('setting.update', $setting->id_setting) }}" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="file" class="form-control" name="background_setting" placeholder="" id="preview_gambar" />
                        </div>
                        <div class="col-md-12 mb-3">
                            <label for="">Preview Banner</label>
                            <img src="{{ asset('background/'.$setting->background_setting) }}" alt="" style="width: 50%; max-width: 100%">
                        </div>      
                        <div class="col-md-12 mb-3">
                            <label for="">Backrgound Tentang</label>
                            <input type="file" class="form-control" name="bg_tentang_setting" placeholder="" id="preview_gambar" />
                        </div>
                        <div class="col-md-12 mb-3">
                            <label for="">Preview Banner</label>
                            <img src="{{ asset('background/'.$setting->bg_tentang_setting) }}" alt="" style="width: 20%; max-width: 100%">
                        </div>      
