            ...
            <div class="card">
                ...
                <div class="card-body table table-responsive">
                    ...
                    <table class="table table-bordered" id="example2">
                        <thead>
                            <tr>
                                <th colspan="col-md-4">No</th>
                                <th colspan="col-md-4">Judul</th>
                                <th colspan="col-md-4">Gambar</th>
                                <th colspan="col-md-4">Aksi</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($galeri as $row)
                                <tr>
                                    ...
                                    <td><img src="{{ asset('file/galeri/'.$row->gambar_galeri) }}" alt="{{ $row->judul_galeri }}" style="width: 100px;"></td>
                                    <td>
