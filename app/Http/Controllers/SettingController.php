...
class SettingController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->background_setting != ""){
            $request->background_setting->move(public_path('background/'), $background);
        }
        if ($request->bg_tentang_setting != ""){
            $request->bg_tentang_setting->move(public_path('background/'), $bg);
        }
